{
  ...
  base-files = {
    ...
    sha256 = "51aa4dc09447e2bb1081a4ba62cee0f843229fc0a1a0f4e208293a72b198785a";
  };
  block-mount = {
    ...
    sha256 = "add07553ea2916e9fc3ef129ea4787bb5d060d714c6f981695dbddc3d95b1d10";
  };
  blockd = {
    version = "2026.05.23~16718b6e-r1";
  ...
  dropbear = {
    ...
    sha256 = "6abe6bf34daf6377caa4aef4d679f4aaaa522d18274189ac06bb18f401a92835";
  };
  dropbearconvert = {
    version = "2025.89-r3";
    ...
    sha256 = "c52ba46f274823e9c050916c78ab044e8034ed17cb46904daf356f95b8443ee8";
  };
  ebtables-nft = {
    version = "1.8.10-r3";
  ...
  fstools = {
    ...
    sha256 = "39c1b998c4596f2de1b26c9b662bd8cd466d67e1e390cc99fa6d736bb47bd1b1";
  };
  fwtool = {
  ...
  iptables-mod-extra = {
    ...
    sha256 = "025e0e34bde60a12cbf3ce86c36f75af101a1cd4b920c6d1a5ad4801521f0554";
  };
  iptables-mod-filter = {
    version = "1.8.10-r3";
  ...
  jboot-tools = {
    ...
    sha256 = "e27ad45706f64113e5ff83b3d5fba94ac52ed52d217588eb8ce8ab4a99181d2c";
  };
  ...
  kernel = {
    version = "6.12.94~2fe195f1cc4f533c70c3c6ea555ac460-r1";
    filename = "kernel-6.12.94~2fe195f1cc4f533c70c3c6ea555ac460-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "f23d0b166500157180fd1a97cc0838c119fa85208183ead59cbb9fca8f8fe529";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  mtd = {
    ...
    provides = [ "mtd-any" ];
    sha256 = "997058c4ac7d9ce36cba3947db8acf2929733c05a8245b82ecbb1a6e816ccf57";
  };
  qosify = {
    ...
    provides = [ "qosify-any" ];
    sha256 = "51b6b5596e9a44dcae075afb79f30b567eaf1a87e671884db5601d7561e81bc5";
  };
  snapshot-tool = {
    version = "2026.05.23~16718b6e-r1";
