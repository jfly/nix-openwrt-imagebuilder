{
  ...
  base-files = {
    ...
    sha256 = "e919ade4f186e66837d0b9b9be74e1557d04c3d0a09a30467bb6354087a8b13f";
  };
  bcm63xx-cfe = {
  ...
  block-mount = {
    ...
    sha256 = "b800958b694c955a69f2b17326aa2c989632c41187cdba4bd53911d36e0272ab";
  };
  blockd = {
    version = "2026.05.23~16718b6e-r1";
  ...
  dropbear = {
    ...
    sha256 = "2223e1e63db1deff00450be169296f8cc0c3daa3c9e0e2adbd38f0ce54c65097";
  };
  dropbearconvert = {
    version = "2025.89-r3";
  ...
  fstools = {
    ...
    sha256 = "a6698b55c14656ea0d0b0382076354cfa72c13bd372923c1248fc0c9d8c5b2f3";
  };
  fwtool = {
  ...
  kernel = {
    version = "6.12.94~26eae9f02aaba4336e2e27a62b63e796-r1";
    filename = "kernel-6.12.94~26eae9f02aaba4336e2e27a62b63e796-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "15a0f5ce5104d43a8e57acb4e456bc93d1bd03a759ee102870a2833f4550a765";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  mtd = {
    ...
    provides = [ "mtd-any" ];
    sha256 = "c034590555e439a2802dbeeeaad817a42d8c6555ffd38a1388e4335fc20e5b89";
  };
  nand-utils = {
    version = "2.3.0-r1";
    ...
    sha256 = "93960e79f3ffeb508fa02beac4febae2b66dd7795251fe3499755084031d9d6f";
  };
  qosify = {
    ...
    provides = [ "qosify-any" ];
    sha256 = "eb0eaa0a3f8c3fc23311bb7ec80367126455dff52dd1293b04ec0a89a2be32e9";
  };
  snapshot-tool = {
    version = "2026.05.23~16718b6e-r1";
  ...
  ubi-utils = {
    ...
    sha256 = "3f5a92c7a7325c78e6bf9d0a0919fa72db2ff9ee1fb13b25fe9988d4ec69cfe3";
  };
  uboot-envtools = {
    version = "2025.10-r2";
  ...
  yafut = {
    ...
    depends = [ "libc" ];
    provides = [ "yafut-any" ];
    sha256 = "0f8fbc9626fd793f721455944ba5bc894e1a6ece81e240053109306c841a80c6";
  };
}
