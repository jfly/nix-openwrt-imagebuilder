{
  ...
  base-files = {
    ...
    sha256 = "d75f72055c4a4ef7e5000aaa06b33850f1702471b8158b0665f1423be74fa0ac";
  };
  block-mount = {
    ...
    sha256 = "3a5a34387e20049e90ed4ea08fdf948e2eb55f7ca84f8d1284018f033a3742da";
  };
  blockd = {
    version = "2026.05.23~16718b6e-r1";
  ...
  fstools = {
    ...
    sha256 = "4fa42f527596dcaffc702a9adf0483432421af50b03e66802768a948175d5b65";
  };
  fwtool = {
  ...
  kernel = {
    version = "6.12.94~588372d5417bb98d012d2b7b2eaceac4-r1";
    filename = "kernel-6.12.94~588372d5417bb98d012d2b7b2eaceac4-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "73adc4f53724b8d2b79df0909747b7b8008ac3e3f295a631e58f97d4589c07a4";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  mtd = {
    ...
    provides = [ "mtd-any" ];
    sha256 = "df02a10d3f95a1bc79feaa9c2f8c0fe845b10f9bb05fcb2bd20bb90b376a54f7";
  };
  nand-utils = {
    version = "2.3.0-r1";
    ...
    sha256 = "b47883bfd3050c30eb97a101fc4dc53e75f47112518a2607700d6845123fe2c1";
  };
  qosify = {
    ...
    provides = [ "qosify-any" ];
    sha256 = "4801e301aec95d9dea231422b306a5b049a4f149e2c987c0899a03840b839e23";
  };
  snapshot-tool = {
    version = "2026.05.23~16718b6e-r1";
  ...
  ubi-utils = {
    ...
    sha256 = "be8f3d142b887e423118ce7d24b37d0f2dfa42a75df742d95a576e32cb43fdff";
  };
  uboot-envtools = {
    version = "2025.10-r2";
  ...
  yafut = {
    ...
    depends = [ "libc" ];
    provides = [ "yafut-any" ];
    sha256 = "c8f5280567372d30e0942f4e72a1f6ea6bccfdeaeb857df2ebd70c76c669a493";
  };
}
