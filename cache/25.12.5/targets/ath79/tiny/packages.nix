{
  ...
  base-files = {
    ...
    sha256 = "4bfa77d92c18f04f483a3faff7bd2de642254acc5c73bae310f3a6b3b64a93f1";
  };
  block-mount = {
  ...
  dropbear = {
    ...
    sha256 = "90da4ebe29af27ca422aa24e4693c1d9cd09afba0f644bf21db27c4b208a11d2";
  };
  dropbearconvert = {
    version = "2025.89-r3";
  ...
  kernel = {
    version = "6.12.94~2c8b611424468df2261de0ac7e428e25-r1";
    filename = "kernel-6.12.94~2c8b611424468df2261de0ac7e428e25-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "150ada98ff67ec0fc10c18c53aedf9b06f85e65c2934eca887880dda7f3c9e6a";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  mtd = {
    ...
    provides = [ "mtd-any" ];
    sha256 = "362af60e08a6c1e7af1b86c802821b43cfffe0f26f033db0bd3a2bdc1f8d8cad";
  };
  nvram = {
    version = "14";
    ...
    depends = [ "libc" ];
    provides = [ "nvram-any" ];
    sha256 = "3c2f2514ca41dbea7dabd1d3bf4536a1bcb256d049c13ff306400791ae420ab6";
  };
  qosify = {
    ...
    provides = [ "qosify-any" ];
    sha256 = "08ee1bf6aeeed688e8cfddefc4fffe8ca216a1b6bcd0fd8b59f3dfd347a21963";
  };
  snapshot-tool = {
    version = "2026.05.23~16718b6e-r1";
