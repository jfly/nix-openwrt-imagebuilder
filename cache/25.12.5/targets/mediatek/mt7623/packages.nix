{
  ...
  base-files = {
    ...
    sha256 = "d13bb32c1900f26d707652265bafe4bda2fd8ce2edab1865f87c3f71d41ed2b5";
  };
  block-mount = {
  ...
  fitblk = {
    ...
    provides = [ "fitblk-any" ];
    sha256 = "3748b4191ecdc728e655d336cc9aa17cee708e489019aebc7917a1a7e6f5cf10";
  };
  fstools = {
    version = "2026.05.23~16718b6e-r1";
  ...
  kernel = {
    version = "6.12.94~07441d4879d9abfed189c732eeb577e1-r1";
    filename = "kernel-6.12.94~07441d4879d9abfed189c732eeb577e1-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "65f51bb7f54538d4954a89cf8ee95fed8b460caf19f0846b1b049b474acc2cc4";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  mtd = {
    ...
    provides = [ "mtd-any" ];
    sha256 = "37e840c9b3cc79cd50b7e03011fb761c0be2e56bd685a7aa4564205e71f0b954";
  };
  nand-utils = {
    version = "2.3.0-r1";
  ...
  qosify = {
    ...
    provides = [ "qosify-any" ];
    sha256 = "8761c368ee4f74760791ed5ce6c1eaff50217cf29c7698482e5ee84f2c26e3b8";
  };
  snapshot-tool = {
    version = "2026.05.23~16718b6e-r1";
  ...
  uboot-envtools = {
    ...
    sha256 = "d92d4966371f372b67a919069a2f640c6070a77b3d7017b6bbcdfd8515e47aad";
  };
  umbim = {
